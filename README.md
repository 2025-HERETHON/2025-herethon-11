...
| 역할        | 이름   | 소속                                  |
| ----------- | ------ | ------------------------------------- |
| 기획·디자인 | 정다빈 | 성신여자대학교 서비스디자인공학과     |
| 프론트엔드  | 김지우 | 덕성여자대학교 디지털소프트웨어공학부 |
| 프론트엔드  | 김성주 | 이화여자대학교 사이버보안학과         |
| 백엔드      | 김민서 | 서울여자대학교 소프트웨어융합학과     |
| 백엔드      | 가유빈 | 동덕여자대학교 컴퓨터학과             |

</br>

## 📂 2025-Herethon-11 폴더 구조
